package com.oracle.passengers.entity;
...
public class Passenger {
    ...
    @Column(name = "checked_in", length = 1, columnDefinition = "CHAR(1)")
    private String checkedIn = "N";

    @Column(name = "wheelchair", length = 1, columnDefinition = "CHAR(1)")
    private String wheelchair = "N";

    @Column(name = "infant", length = 1, columnDefinition = "CHAR(1)")
